...
module.exports = [
  ...
  },
  {
    ...
    rules: {
      ...
      "playwright/expect-expecte": "error", //enforce assertion to be made in a test body
      "playwirght/missing-playwright-await": "error", //enforce Playwright APIs to be await
